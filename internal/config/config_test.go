...
func TestApplyEnvironment(t *testing.T) {
	...
	t.Setenv("CLIPBOARD_EXCHANGE_SHORT_LINK_RATE_LIMIT", "17")
	t.Setenv("CLIPBOARD_EXCHANGE_MAX_SHORT_LINKS", "321")
	...
	if cfg.Listen != "127.0.0.1:9090" || cfg.DatabasePath != "/tmp/exchange.db" || cfg.RoomTTL != 48*time.Hour || cfg.MaxItemsPerRoom != 42 || cfg.ShortLinkRateLimit != 17 || cfg.MaxShortLinks != 321 || !cfg.TrustProxy || cfg.FilesDir != "/tmp/exchange-files" || cfg.MaxRoomFileBytes != 123456 || cfg.UploadTTL != 2*time.Hour {
